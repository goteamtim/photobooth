...
GPIO.add_event_detect(23, GPIO.FALLING, callback=takePicture, bouncetime=300) #When the button is pressed, it calls the take picture function
...
print 'Press the button to take some pictures.'

x = str(raw_input("Would you like to exit? (yes or no)"))
